	...
	if (_.includes(allowedTypesForCrates, unit.type) && proximityController.unitInProxLogiTowers(unit, serverName)) {
		if(unit.coalition === 1) {
			...
			cmdArray = _.concat(cmdArray, [
				...
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Early Warning Radar Short(1)", {"Acquisitions(Stationary)","Support"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "EWR", ["type"] = "1L13 EWR", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "false"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Early Warning Radar Long(2)", {"Acquisitions(Stationary)","Support"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "EWR", ["type"] = "55G6 EWR", ["unitId"] = ' + unit.unitId + ', ["crates"] = 2, ["mobile"] = "false"})',
