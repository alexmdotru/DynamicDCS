	...
	if (_.includes(allowedTypesForCrates, unit.type) && proximityController.unitInProxLogiTowers(unit, serverName)) {
		if(unit.coalition === 1) {
			cmdArray = _.concat(cmdArray, [
				...
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Early Warning Radar Short(1M)", {"Acquisitions(Mobile)","Support"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "EWR", ["type"] = "1L13 EWR", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Early Warning Radar Long(2M)", {"Acquisitions(Mobile)","Support"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "EWR", ["type"] = "55G6 EWR", ["unitId"] = ' + unit.unitId + ', ["crates"] = 2, ["mobile"] = "true"})',
				...
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "T-90(4M)", {"Acquisitions(Mobile)", "Tanks"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "tank", ["type"] = "T-90", ["unitId"] = ' + unit.unitId + ', ["crates"] = 4, ["mobile"] = "true"})',
				...
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "ZU-23 Emplacement(1M)", {"Acquisitions(Mobile)", "AntiAir"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "stationaryAntiAir", ["type"] = "ZU-23 Emplacement", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "ZU-23 Emplacement Closed(1M)", {"Acquisitions(Mobile)", "AntiAir"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "stationaryAntiAir", ["type"] = "ZU-23 Emplacement Closed", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				...
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Osa 9A33 ln(2M)", {"Acquisitions(Mobile)", "Radar SAM"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "mobileSAM", ["type"] = "Osa 9A33 ln", ["unitId"] = ' + unit.unitId + ', ["crates"] = 2, ["mobile"] = "true"})',
...
*/
		...
		if(unit.coalition === 2) {
			cmdArray = _.concat(cmdArray, [
				...
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Early Warning Radar Short(1M)", {"Acquisitions(Mobile)","Support"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "EWR", ["type"] = "1L13 EWR", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Early Warning Radar Long(2M)", {"Acquisitions(Mobile)","Support"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "EWR", ["type"] = "55G6 EWR", ["unitId"] = ' + unit.unitId + ', ["crates"] = 2, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "JTAC (1M)", {"Acquisitions(Mobile)","Support"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "JTAC", ["type"] = "Hummer", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Fuel Tanker(1M)", {"Acquisitions(Mobile)","Support"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "unarmedFuel", ["type"] = "M978 HEMTT Tanker", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Ammo Truck(1M)", {"Acquisitions(Mobile)","Support"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "unarmedAmmo", ["type"] = "M 818", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',

				'missionCommands.addSubMenuForGroup("' + unit.groupId + '", "Armored Cars", {"Acquisitions(Mobile)"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Humvee TOW(1M)", {"Acquisitions(Mobile)", "Armored Cars"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "armoredCar", ["type"] = "M1045 HMMWV TOW", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Humvee MGS(1M)", {"Acquisitions(Mobile)", "Armored Cars"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "armoredCar", ["type"] = "M1043 HMMWV Armament", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',

				'missionCommands.addSubMenuForGroup("' + unit.groupId + '", "IFVs", {"Acquisitions(Mobile)"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Marder(1M)", {"Acquisitions(Mobile)", "IFVs"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "APC", ["type"] = "Marder", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "TPZ(1M)", {"Acquisitions(Mobile)", "IFVs"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "APC", ["type"] = "TPZ", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "AAV7(1M)", {"Acquisitions(Mobile)", "IFVs"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "APC", ["type"] = "AAV7", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "M-113(1M)", {"Acquisitions(Mobile)", "IFVs"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "APC", ["type"] = "M-113", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "LAV-25(1M)", {"Acquisitions(Mobile)", "IFVs"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "APC", ["type"] = "LAV-25", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "M-2 Bradley(2M)", {"Acquisitions(Mobile)", "IFVs"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "APC", ["type"] = "M-2 Bradley", ["unitId"] = ' + unit.unitId + ', ["crates"] = 2, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Stryker MGS(2M)", {"Acquisitions(Mobile)", "IFVs"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "APC", ["type"] = "M1128 Stryker MGS", ["unitId"] = ' + unit.unitId + ', ["crates"] = 2, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Stryker ATGM(2M)", {"Acquisitions(Mobile)", "IFVs"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "APC", ["type"] = "M1134 Stryker ATGM", ["unitId"] = ' + unit.unitId + ', ["crates"] = 2, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Stryker ICV(2M)", {"Acquisitions(Mobile)", "IFVs"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "APC", ["type"] = "M1126 Stryker ICV", ["unitId"] = ' + unit.unitId + ', ["crates"] = 2, ["mobile"] = "true"})',

				'missionCommands.addSubMenuForGroup("' + unit.groupId + '", "Tanks", {"Acquisitions(Mobile)"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Leopard1A3(2M)", {"Acquisitions(Mobile)", "Tanks"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "tank", ["type"] = "Leopard1A3", ["unitId"] = ' + unit.unitId + ', ["crates"] = 2, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Leopard-2(4M)", {"Acquisitions(Mobile)", "Tanks"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "tank", ["type"] = "Leopard-2", ["unitId"] = ' + unit.unitId + ', ["crates"] = 4, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Challenger2(4M)", {"Acquisitions(Mobile)", "Tanks"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "tank", ["type"] = "Challenger2", ["unitId"] = ' + unit.unitId + ', ["crates"] = 4, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "M-1 Abrams(4M)", {"Acquisitions(Mobile)", "Tanks"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "tank", ["type"] = "M-1 Abrams", ["unitId"] = ' + unit.unitId + ', ["crates"] = 4, ["mobile"] = "true"})',

				'missionCommands.addSubMenuForGroup("' + unit.groupId + '", "Artillary & MLRS", {"Acquisitions(Mobile)"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "M-109(1M)", {"Acquisitions(Mobile)", "Artillary & MLRS"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "artillary", ["type"] = "M-109", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "SAU 2-C9(1M)", {"Acquisitions(Mobile)", "Artillary & MLRS"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "artillary", ["type"] = "SAU 2-C9", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "SAU Gvozdika(1M)", {"Acquisitions(Mobile)", "Artillary & MLRS"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "artillary", ["type"] = "SAU Gvozdika", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "SAU Akatsia(2M)", {"Acquisitions(Mobile)", "Artillary & MLRS"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "artillary", ["type"] = "SAU Akatsia", ["unitId"] = ' + unit.unitId + ', ["crates"] = 2, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "MLRS(1M)", {"Acquisitions(Mobile)", "Artillary & MLRS"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "mlrs", ["type"] = "MLRS", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Uragan_BM-27(1M)", {"Acquisitions(Mobile)", "Artillary & MLRS"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "mlrs", ["type"] = "Uragan_BM-27", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Smerch(2M)", {"Acquisitions(Mobile)", "Artillary & MLRS"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "mlrs", ["type"] = "Smerch", ["unitId"] = ' + unit.unitId + ', ["crates"] = 2, ["mobile"] = "true"})',
				...
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Vulcan(2M)", {"Acquisitions(Mobile)", "AntiAir"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "mobileAntiAir", ["type"] = "Vulcan", ["unitId"] = ' + unit.unitId + ', ["crates"] = 2, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Gepard(3M)", {"Acquisitions(Mobile)", "AntiAir"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "mobileAntiAir", ["type"] = "Gepard", ["unitId"] = ' + unit.unitId + ', ["crates"] = 3, ["mobile"] = "true"})',

				'missionCommands.addSubMenuForGroup("' + unit.groupId + '", "Infrared SAM", {"Acquisitions(Mobile)"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Avenger(1M)", {"Acquisitions(Mobile)", "Infrared SAM"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "samIR", ["type"] = "M1097 Avenger", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Chaparral(2M)", {"Acquisitions(Mobile)", "Infrared SAM"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "samIR", ["type"] = "M48 Chaparral", ["unitId"] = ' + unit.unitId + ', ["crates"] = 2, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Linebacker(2M)", {"Acquisitions(Mobile)", "Infrared SAM"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "samIR", ["type"] = "M6 Linebacker", ["unitId"] = ' + unit.unitId + ', ["crates"] = 2, ["mobile"] = "true"})',

				'missionCommands.addSubMenuForGroup("' + unit.groupId + '", "Radar SAM", {"Acquisitions(Mobile)"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Tunguska(3M)", {"Acquisitions(Mobile)", "Radar SAM"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "mobileSAM", ["type"] = "2S6 Tunguska", ["unitId"] = ' + unit.unitId + ', ["crates"] = 3, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Tor(3M)", {"Acquisitions(Mobile)", "Radar SAM"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "mobileSAM", ["type"] = "Tor 9A331", ["unitId"] = ' + unit.unitId + ', ["crates"] = 3, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Roland(3M)", {"Acquisitions(Mobile)", "Radar SAM"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "MRSAM", ["type"] = "Roland", ["unitId"] = ' + unit.unitId + ', ["crates"] = 3, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "SA-3(3M)", {"Acquisitions(Mobile)", "Radar SAM"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "MRSAM", ["type"] = "SA-3", ["unitId"] = ' + unit.unitId + ', ["crates"] = 3, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Kub(3M)", {"Acquisitions(Mobile)", "Radar SAM"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "MRSAM", ["type"] = "Kub", ["unitId"] = ' + unit.unitId + ', ["crates"] = 3, ["mobile"] = "true"})',
				'missionCommands.addCommandForGroup("' + unit.groupId + '", "Buk(4M)", {"Acquisitions(Mobile)", "Radar SAM"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "LRSAM", ["type"] = "Buk", ["unitId"] = ' + unit.unitId + ', ["crates"] = 4, ["mobile"] = "true", ["mobile"] = "true"})',
