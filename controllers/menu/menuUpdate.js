						...
						if (_.includes(allowedTypesForCrates, unit.type) && logiFarpName) {
							if(unit.coalition === 1) {
								cmdArray = _.concat(cmdArray, [
									...
									'missionCommands.addCommandForGroup("' + unit.groupId + '", "Strela-1 9P31(1M)", {' + aqMenuTitle + ', "Infrared SAM"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "samIR", ["type"] = "Strela-1 9P31", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
							...
							if(unit.coalition === 2) {
								cmdArray = _.concat(cmdArray, [
									...
									'missionCommands.addSubMenuForGroup("' + unit.groupId + '", "Infrared SAM", {' + aqMenuTitle + '})',
									'missionCommands.addCommandForGroup("' + unit.groupId + '", "Avenger(1M)", {' + aqMenuTitle + ', "Infrared SAM"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "samIR", ["type"] = "M1097 Avenger", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true"})',
