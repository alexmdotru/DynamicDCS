        ...
        .then(function (curPlayerDB) {
            ...
            if (newLifeCount !== 0) {
                ...
                if (!playerCommObj && isDiscordAllowed) {
                    var mesg = "REQUIREMENT(" + newLifeCount + " mins left):You are not a member of the DDCS discord(with your name matching EXACTLY) and also you need to be in a VOICE discord channel(Status is online(not invisi)) OR connected to the correct SRS server (" + _.get(SRSServers, [serverName]) + ") https://discord.gg/h4G9QZf ";
                    ...
                    var mesg = "REQUIREMENT(" + newLifeCount + " mins left):You need to be in a VOICE discord channel(Status is online(not invisi)) OR connected to the correct SRS server (" + _.get(SRSServers, [serverName]) + "), https://discord.gg/h4G9QZf ";
                ...
                if (!playerCommObj && isDiscordAllowed) {
                    var mesg = "KICKED: You are not a member of the DDCS discord(with your name matching EXACTLY) and also you need to be in a VOICE discord channel(Status is online(not invisi)) OR connected to the correct SRS server (" + _.get(SRSServers, [serverName]) + ") https://discord.gg/h4G9QZf ";
                    ...
                    var mesg = "KICKED: You need to be in a VOICE discord channel(Status is online(not invisi)) OR connected to the SRS correct server (" + _.get(SRSServers, [serverName]) + "), https://discord.gg/h4G9QZf ";
